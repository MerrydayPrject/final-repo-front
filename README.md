...
- 프론트엔드 개발: 사용자 이미지 업로드, 드레스 매칭 UI, 마이페이지/즐겨찾기 기능 구현

- 3D 드레스 시각화: Three.js 활용, 회전 및 포즈 변경 기능 개발

- AI 이미지 합성 연동: 사용자 전신 이미지 + 드레스 이미지 → 체형 맞춤 피팅 결과 제공

- 메인 영상 기획 및 구성: 서비스 핵심 기능과 체험 과정 직관적으로 전달

- UI/UX 최적화: 로딩 스피너, 모달, 자동 스크롤 적용, Tailwind CSS로 반응형 UI 구현
