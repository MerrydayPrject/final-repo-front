                ...
                <div className={`content-wrapper ${showResult ? 'show-result' : ''}`}>
                    ...
                    {!showResult && (
                        <>
                            ...
                            <div className="custom-upload-layout">
                    ...
                    {/* 결과 모드 */}
                    {showResult && (
                        <div className="custom-result-view">
                            <button className="back-button" onClick={handleBackToUpload}>
                                ← 뒤로가기
                            </button>
                            <div className="custom-result">
                                <div className={`result-container ${customResultImage ? 'has-result' : ''}`}>
                                    {isMatching ? (
